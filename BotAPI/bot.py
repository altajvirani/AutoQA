...
f=open( 'D:\Downloads\AutoQA\BotAPI\\NLPfiles\\Nlp python answer finals.txt', 'r', errors ='ignore' )
m=open( 'D:\Downloads\AutoQA\BotAPI\\NLPfiles\modules pythons.txt', 'r', errors ='ignore' )
...
Introduce_Ans = ["My name is AutoQA Bot.","My name is AutoQA Bot you can called me Pi.","I'm AutoQA Bot :) ","My name is AutoQA Bot, and my nickname is Py and I am happy to solve your queries :) "]
GREETING_INPUTS = ("hello", "hi","hiii","hii","hiiii","hiiii", "greetings", "sup", "what's up","hey", "wassup",)
GREETING_RESPONSES = ["hi", "hey", "hii there", "hi there", "hello", "I am glad that you are talking to me!",]
